...
static const RPC_CLIENT_INTERFACE BackdoorInterface___RpcClientInterface =
    {
...
RPC_IF_HANDLE BackdoorInterface_v1_0_c_ifspec = (RPC_IF_HANDLE)& BackdoorInterface___RpcClientInterface;

extern const MIDL_STUB_DESC BackdoorInterface_StubDesc;

static RPC_BINDING_HANDLE BackdoorInterface__MIDL_AutoBindHandle;
    ...
    /* [out] */ LPSTR *out_str)
{
    ...
    NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&BackdoorInterface_StubDesc,
                  (PFORMAT_STRING) &rpc_backdoor_server__MIDL_ProcFormatString.Format[0],
                  in_str,
                  out_str);
...
static const MIDL_STUB_DESC BackdoorInterface_StubDesc = 
    {
    (void *)& BackdoorInterface___RpcClientInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    &ImplicitHandle,
    0,
